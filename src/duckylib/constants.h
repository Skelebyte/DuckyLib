...
const char *dl_vert_shader = "#version 450 core\n"
...
const char *dl_frag_shader = "#version 450 core\n"
"out vec4 FragColor;\n"
...
const char *dl_ui_vert_shader = "#version 450 core\n"
"layout(location = 0) in vec3 a_pos;\n"
"layout(location = 1) in vec2 a_texture_coords;\n"
"out vec3 FragPosition;\n"
"out vec2 texture_coords;\n"
...
const char *dl_ui_frag_shader = "#version 450 core\n"
"out vec4 FragColor;\n"
"in vec2 texture_coords;\n"
"uniform sampler2D texture_sample;\n"
"uniform vec4 color;\n"
